...
#ifdef NAM
			sprintf(namtemp,"%s TALK",basename);
            menutext(c,50+16+16+16+16,SHX(-6),(FXDevice==NumSoundCards)||SoundToggle==0,namtemp);
#else
...
#else
            else if(ud.m_coop==2) gametext(c+70,57-7-9,"GI MATCH (NO SPAWN)",0,2+8+16);
            else gametext(c+70,57-7-9,"GI MATCH (SPAWN)",0,2+8+16);
#endif
#else
            else if(ud.m_coop==2) gametext(c+70,57-7-9,"GRUNTMATCH (NO SPAWN)",0,2+8+16);
            else gametext(c+70,57-7-9,"GRUNTMATCH (SPAWN)",0,2+8+16);
#endif
#else
            else if(ud.m_coop==2) gametext(c+70,57-7-9,"DUKEMATCH (NO SPAWN)",0,2+8+16);
            else gametext(c+70,57-7-9,"DUKEMATCH (SPAWN)",0,2+8+16);
...
#endif
#ifdef WW2			
            menutext(c,57+16+16+16-9,SHX(-5),PHX(-5),"ENEMIES");
#else
